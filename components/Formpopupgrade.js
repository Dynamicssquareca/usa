  ...
  const handleSubmit = async (e) => {
    ...
    if (Object.keys(validationErrors).length === 0) {
      ...
      try {
        ...
        await emailjs.sendForm('service_ioc4m3m', 'template_gbl6xx5', e.target, 'Z1IXZpfjgq01m5vW7');
    ...
    <div className="main-form-wrper main-form-wrper-toster">
     <form ref={form} onSubmit={handleSubmit}>
          <div className="mb-3">
            ...
            <input type="hidden" value="Form Popup Upgrade" name="formtag" />
