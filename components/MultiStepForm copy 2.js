...
const MultiStepForm = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch('https://blognew.dynamicssquare.com/api/estimation-submit', {
          method: 'POST',
          headers: {
  ...
  return (
    ...
    className='btn-submit button-group-stylea'
    disabled={isSubmitting} // Disable button while submitting
>
    {isSubmitting ? (
        <span className="loader"></span> // Add your loader component or text
    ) : (
        'See Your Estimate'
    )}
</button>
