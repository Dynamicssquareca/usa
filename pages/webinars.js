                    ...
                    <div className="col-lg-6">
                      ...
                      <a href="https://www.youtube.com/watch?v=pzA1OdN79nI" traget="_blank" className="over-ff">
                        ...
                        <div className="card-body">
                          ...
                          <div class="btn-003 btn-009"><a class="btn btn-sm btn-danger" href="https://www.youtube.com/watch?v=pzA1OdN79nI" traget="_blank">Watch Now</a></div>
                        </div>
                      </div>
                    </div>
                    <div className="col-lg-6">
                      ...
                      <a href="https://youtu.be/AzXqHqEoocY" traget="_blank" className="over-ff">
                        ...
                        <div className="card-body">
                          ...
                          <div class="btn-003 btn-009"><a class="btn btn-sm btn-danger" href="https://youtu.be/AzXqHqEoocY" traget="_blank">Watch Now</a></div>
                        </div>
                      </div>
                    </div>
                    <div className="col-lg-6">
                      ...
                      <a href="https://www.youtube.com/watch?v=Evkj4zfpk0Q" traget="_blank" className="over-ff">
                        ...
                        <div className="card-body">
                          ...
                          <div class="btn-003 btn-009"><a class="btn btn-sm btn-danger" href="https://www.youtube.com/watch?v=Evkj4zfpk0Q" traget="_blank">Watch Now</a></div>
                        </div>
                      </div>
                    </div>
                    <div className="col-lg-6">
                    ...
                    <div className="col-lg-6">
                      ...
                      <a href="https://www.youtube.com/watch?v=4sdOb8PUE-o" traget="_blank" className="over-ff">
                        ...
                        <div className="card-body">
                          ...
                          <div class="btn-003 btn-009"><a class="btn btn-sm btn-danger" href="https://www.youtube.com/watch?v=4sdOb8PUE-o" traget="_blank">Watch Now</a></div>
                        </div>
                      </div>
                    </div>
                  </div>
