                ...
                >
                  <div className="row">
                    <div className="col-lg-6">
                      ...
                      <a href="https://www.youtube.com/watch?v=pzA1OdN79nI" traget="_blank" className="over-ff">
                          <img
                            className="card-img-top"
                            src="/img/iot_youtube-thumbnail.png"
                        ...
                        <div className="card-body">
                          <h5 className="card-title">
                            <a href="https://www.youtube.com/watch?v=pzA1OdN79nI" traget="_blank">Azure IoT Central Webinar</a>
                          </h5>
                          ...
                          <div className="btn-003 btn-009"><a className="btn btn-sm btn-danger" href="https://www.youtube.com/watch?v=pzA1OdN79nI" traget="_blank">Watch Now</a></div>
                        </div>
                      </div>
                    </div>
                    <div className="col-lg-6">
                      <div className="card card-custom-1">
                      <a href="https://youtu.be/AzXqHqEoocY" traget="_blank" className="over-ff">
                          <img
                            className="card-img-top"
                            src="/img/Azure-IoT-Thumbnail.jpg"
                        ...
                        <div className="card-body">
                          <h5 className="card-title">
                            <a href="https://youtu.be/AzXqHqEoocY" traget="_blank">Azure IoT Webinar</a>
                          </h5>
                          ...
                          <div className="btn-003 btn-009"><a className="btn btn-sm btn-danger" href="https://youtu.be/AzXqHqEoocY" traget="_blank">Watch Now</a></div>
                        </div>
                      </div>
                    </div>
                    <div className="col-lg-6">
                      <div className="card card-custom-1">
                      <a href="https://www.youtube.com/watch?v=Evkj4zfpk0Q" traget="_blank" className="over-ff">
                          <img
                            className="card-img-top"
                            src="/img/Webinar-3.jpg"
                            alt="iot_youtube-thumbnail"
                          />
                          <span>
                            <i className="bi bi-play-circle-fill"></i>
                        ...
                        <div className="card-body">
                          <h5 className="card-title">
                            <a href="https://www.youtube.com/watch?v=Evkj4zfpk0Q" traget="_blank">Introduction to Power BI</a>
                          </h5>
                          ...
                          <div className="btn-003 btn-009"><a className="btn btn-sm btn-danger" href="https://www.youtube.com/watch?v=Evkj4zfpk0Q" traget="_blank">Watch Now</a></div>
                        </div>
                      </div>
                    </div>
                    <div className="col-lg-6">
                      <div className="card card-custom-1">
                      <a href="https://www.youtube.com/watch?v=OI4H1Lxxk9E" traget="_blank" className="over-ff">
                          <img
                            className="card-img-top"
                            src="/img/Webinar-2.jpg"
                            alt="iot_youtube-thumbnail"
                          />
                          <span>
                            <i className="bi bi-play-circle-fill"></i>
                        ...
                        <div className="card-body">
                          ...
                          <div className="btn-003 btn-009"><a className="btn btn-sm btn-danger" href="https://www.youtube.com/watch?v=OI4H1Lxxk9E" traget="_blank">Watch Now</a></div>
                        </div>
                      </div>
                    </div>
                    <div className="col-lg-6">
                      <div className="card card-custom-1">
                      <a href="https://www.youtube.com/watch?v=4sdOb8PUE-o" traget="_blank" className="over-ff">
                          <img
                            className="card-img-top"
                            src="/img/Webinar-1.jpg"
                            alt="iot_youtube-thumbnail"
                          />
                          <span>
                            <i className="bi bi-play-circle-fill"></i>
                        ...
                        <div className="card-body">
                          <h5 className="card-title">
                            <a href="https://www.youtube.com/watch?v=4sdOb8PUE-o" traget="_blank">Dynamics NAV to Dynamics 365 Business Central Upgrade</a>
                          </h5>
                          ...
                          <div className="btn-003 btn-009"><a className="btn btn-sm btn-danger" href="https://www.youtube.com/watch?v=4sdOb8PUE-o" traget="_blank">Watch Now</a></div>
                        </div>
                      </div>
                    </div>
                  </div>
