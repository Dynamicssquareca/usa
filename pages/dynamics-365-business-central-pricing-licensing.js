  ...
  return (
    <>
      <Head>
        ...
        <link
          rel="canonical"
          href="https://www.dynamicssquare.com/dynamics-365-business-central-pricing-licensing/"
        />
      </Head>
        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-lg-8">
              <header className="section-header">
                <h2>
                  Invest In a Flexible, Scalable, & Result-Driven Solution
                </h2>
                <p>
                  D365 Business Central quickly adapts to your specific business
                  needs and helps streamline your accounting, supply chain,
                  production delays, equipment downtime, quality delivery, and
                  more. Embedded with{" "}
                  <Link href="/products/azure-iot-internet-of-things/">
                    Azure IoT intelligence
                  </Link>
                  , you can remotely monitor your devices and service equipment.
                </p>
                <p>
                  <b>
                    Discover More About Business Central SaaS Subscription Plans
                  </b>
                </p>
              </header>
            </div>
            ...
            <div className="col-lg-9">
              <div className="side-heading-custom-02">
                <h3 className="text-center">
                  Migrating From Dynamics NAV to Business Central? We Can Help!
                </h3>
              </div>
              <div className="custom-p-001">
                <p>
                  ...
                  is an excellent ERP tool to fulfil your needs, but it lacks
                  many features that Business Central brings with it, like cloud
                  storage, data-driven business intelligence (BI), and
                  integration with Power Apps or Power Automate.
                </p>
                <p>
                  If you are still using your Dynamics NAV ERP, you can migrate
                  to Business Central for extraordinary features and benefits,
                  from quoting, invoicing & payment, purchasing and inventory
                  management, reporting & analytics, finance, budgets/estimates,
                  inventory control, item substitutions, returns and
                  cancellations, project management, purchase order sales
                  invoicing, sales order management, pricing & discounting,
                  contact management, opportunity management, and interaction
                  management to connect all of your business, make better
                  decisions, and start growing easily.
                </p>
              </div>
            </div>
            {/* <div className="col-lg-4 align-self-center">
          ...
          <div className="row justify-content-center">
            <div className="col-lg-9">
              <div className="call-to-action-content">
                <h3>Why Choose Dynamics Square?</h3>
                <p>
                  At Dynamics Square, you can get the dedicated support and
                  services you deserve. We have a team of professionals
                  proactively helping small businesses with a successful{" "}
                  <Link href="/dynamics-365-business-central-implementation/">
                ...
                <p>
                  Our years of experience working with small and mid-sized
                  businesses help us know the exact issues they face while
                  operating ERPs like Dynamics NAV and Business Central.
                </p>
...
export default BusinessCentralPricingLicensing;
