...
const MicrosoftDynamics365FinanceOperationsold = () => {
          ...
          <div className="row pp-top-60 pp-bot-60 rever-1">
            ...
            <div className="col-lg-6">
              <div className="nw-bc-lef-h">
                ...
                <p>Microsoft Dynamics 365 for Finance and Operations is a powerful ERP solution for complex and diversified businesses to manage financial and supply chain operations. With the sheer capabilities of AI, BI, and automation, it lets businesses manage global operations while pushing growth towards scalability.</p>
                <p><strong>D365 F&O enables you to make:</strong></p>
                <div className="points-ui"><i className="bi bi-check-lg"></i> <span>Smart decisions with real-time data</span></div>
          ...
          <div className="row pp-top-60 pp-bot-60 pp-mar-30 rever-1">
            ...
            <div className="col-lg-6">
              <div className="nw-bc-lef-h">
                ...
                <p><strong>The inventory module of Dynamics 365 F&O will enable you:</strong></p>
                ...
                <div className="points-ui"><i className="bi bi-check-lg"></i> <span>Multi-currency support for international markets</span></div>
              </div>
            </div>
                          ...
                          <div className="col-lg-6 col-md-6">
                            <div className="busines-service-list">
                              ...
                              <div className="content">
                                ...
                                <p>Optimize and manage budgets while calculating credit or debit funds in real-time.</p>
                              </div>
                            </div>
                          </div>
                          <div className="col-lg-6 col-md-6">
          ...
          <div className="row">
            <div className="col-lg-8 align-self-center">
              <div className="left--side-title">
                ...
                <p>Microsoft Dynamics 365 Finance and Operations comes with numerous benefits that support the business as it grows and expands to greater heights.</p>
          ...
          <div className="row bc--top-pad">
            <div className="col-lg-3">
              <div className="bc--feat-box">
                ...
                <p>Cloud deployment enables the business to avail of real-time analytics for a streamlined decision-making process. Such data insights will help you make informed decisions with 100% visibility across different processes. </p>
              </div>
            </div>
            <div className="col-lg-3">
              <div className="bc--feat-box">
                ...
                <p>Microsoft offers interactive and similar kinds of user experiences with all its business solutions. This similarity of different applications empowers the user to operate a solution in a better way from the first point of contact. </p>
              </div>
            </div>
            <div className="col-lg-3">
              <div className="bc--feat-box">
          ...
          <div className="row pp-top-60 pp-bot-60">
            <div className="col-lg-6">
              <div className="nw-bc-lef-h">
                ...
                <p><strong>However, most businesses, decision-makers, and consultants consider this a single solution: Microsoft Dynamics 365 Finance and Operations.</strong></p>
            ...
            <div className="col-lg-6 align-self-center">
              <div className="col-to-content">
                ...
                <Link href="/contact-us/">
                  <a className="btn btn-md">Connect with the Dynamics 365 F&O Expert  </a>
                </Link>
              </div>
            </div>
          </div>
          ...
          <div className="row justify-content-center">
            <div className="col-lg-9">
              <div className="heading-colo-bg">
                ...
                <p>Based on your business requirements, you can opt for a solution or both to accelerate your business.</p>
              </div>
            </div>
          </div>
          ...
          <div className="row justify-content-center">
            <div className="col-lg-5">
              <div className="top-text-wrpaer">
                ...
                <p>Microsoft Dynamics 365 Finance is a robust ERP solution that can streamline complex financial processes with ease. It comes with sufficient tools and capabilities required by a modern business to deal with modern issues.</p>
              </div>
            ...
            <div className="col-lg-6">
              <div className="bc---soprt">
                ...
                <div className="rig">
                  ...
                  <p>We have 150+ consultants available 24x7 to help you get started resolving your complex issues in no time. </p>
                </div>
              </div>
            </div>
            <div className="col-lg-6">
...
export default MicrosoftDynamics365FinanceOperationsold;
