  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Dynamics 365 Not for Profit Accelerator is meant to empower nonprofits to achieve objectives without losing focus on delivering quality service and maintaining strong relations with donors and volunteers."
        />
        <link
          rel="canonical"
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-6 mobile-1 align-self-center">
              <h1>Not for Profit Accelerator</h1>
              <p>
                Realize Your Mission Coming True Through Secure and Reliable
                Microsoft Solution Microsoft Dynamics 365 Non-Profit Accelerator
                is meant to empower not-for-profit and other charitable
                organizations to achieve their objectives without losing focus
                on delivering quality service and maintaining strong relations
                with donors and volunteers who make achieving success possible.
              ...
              <div className="row justify-content-center">
                <div className="col-lg-8 col-md-8">
                  <header className="section-header">
                    ...
                    <p>
                      The primary aim of Microsoft Dynamics 365 Non-Profit
                      Accelerator is to fuel not-for-profit processes such as
                      program delivery, supporter and volunteer management,
                  ...
                  <div className="accordion-item">
                    <h3 className="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in">
                          <img
                            src="/img/icon-non-profit-volunteer-engagement.svg"
                            alt="Increase donor and volunteer engagement"
                          />
                        </div>
                  ...
                  <div className="accordion-item">
                    <h3 className="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in">
                          <img
                            src="/img/icon-non-profit-donation-management.svg"
                  ...
                  <div className="accordion-item">
                    <h3 className="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in">
                          <img
                            src="/img/icon-non-profit-fund-raising.svg"
                            alt="Fundraising"
                          />
                        </div>
                    ...
                    >
                      <div className="accordion-body">
                        <p>
                          The nonprofit accelerator can track all major stages
                          of high-touch fundraising.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="accordion-item">
                    <h3 className="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in">
                          <img
                            src="/img/icon-non-profit-award-management.svg"
                            alt="Award management"
                          />
                        </div>
                  ...
                  <div className="accordion-item">
                    <h3 className="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in">
                          <img
                            src="/img/icon-non-profit-program-delivery.svg"
                  ...
                  <div className="accordion-item">
                    <h3 className="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in">
                          <img
                            src="/img/icon-non-profit-volunteer-management.svg"
                    ...
                    >
                      <div className="accordion-body">
                        ...
                        <p>
                          D365 NonProfit Accelerator can help organize and
                          optimize a charity’s volunteer force, with rostering
                          and timesheet features, and profile management that
                          allows non-profits to assign the right volunteers to
                          the right project.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="accordion-item">
                    <h3 className="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in">
                          <img
                            src="/img/icon-non-profit-member-management.svg"
                  ...
                  <div className="accordion-item">
                    <h3 className="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in">
                          <img
                            src="/img/icon-non-profit-finance.svg"
                  ...
                  <div className="accordion-item">
                    <h3 className="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in">
                          <img
                            src="/img/icon-non-profit-case-management.svg"
                            alt="Case management"
                          />
                        </div>
                  ...
                  <div className="accordion-item">
                    <h3 className="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in">
                          <img
                            src="/img/icon-non-profit-project-management.svg"
                  ...
                  <div className="accordion-item">
                    <h3 className="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in">
                          <img
                            src="/img/icon-non-profit-functionality.svg"
                            alt="Functionality"
                          />
                        </div>
                    ...
                    >
                      <div className="accordion-body">
                        ...
                        <p>
                          Nonprofit operations toolkit- In order to support this
                          application, this solution depends on the nonprofit
                          core data schema.
                        </p>
                        <p>
                          Common Data Model for Nonprofits sample apps- In order
                          to support this application, this solution depends on
                          the nonprofit core data schema.
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            <div className="col-lg-9">
              <div className="call-to-action-content">
                ...
                <div className="text-center m-o-t new-btn-nn">
                  <Link href="/industries/non-profits/">
