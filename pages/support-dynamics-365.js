      ...
      >
        <div className="container">
          <div className="row">
            ...
            <div id='action-call' className="col-lg-5  align-self-center">
                  ...
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body">
                        <p>
                          <ul>
                            <li>Protect your investments, reduce cost and risks.</li>
                            <li>Access to support-specific resources and gain insight into best practices to help optimize your products and services.</li>
                            <li>Take advantage of expertise and knowledge.</li>
                          </ul>
                        </p>
                      </div>
                    </div>
                ...
                <div className="accordion" id="accnews">
                  <div className="accordion-item">
                    ...
                    >
                      ...
                      <p>
                          <ul>
                            <li>No contracts & Prepaid Hours </li>
                            <li>Monthly or Yearly Support </li>
                            <li>Custom Support Model </li>
                          </ul>
                        </p>
                      </div>
                    </div>
            ...
            <div className="col-lg-12 col-md-12">
              <div className="price-btn d-flex justify-content-center">
                  <a className="btn-get-red" href="#action-call">
                    <span>Get Business Central Support today?</span>
                  </a>
      ...
      <section className="bg-333">
        <div className="container">
          ...
          <div className='row justify-content-center'>
            ...
            <p style={{color:'var(--color-red)',fontSize:'20px'}}><b>How do I get technical support for Business Central? </b></p>
            <p>Business Central is sold through partners, therefore you should contact a reselling partner for technical assistance.</p>
