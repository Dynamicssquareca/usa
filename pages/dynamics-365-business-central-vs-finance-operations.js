        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-6 align-self-center">
              <Image src="/img/bs-vsfin.png" alt="bs-vsfin" width={602} height={315}/>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="row">
            <div className="col-lg-5">
              <div className="content-box-222">
                ...
                <p>
                  <Link href="/products/microsoft-dynamics-365-finance/">Dynamics 365 Finance</Link> & <Link href="/products/dynamics-365-supply-chain-management/">Supply Chain</Link>  (formerly <Link href="/products/microsoft-dynamics-365-finance-operations/">Finance and
                  Operations</Link>) is widely renowned as Microsoft's most advanced
            ...
            <div className="col-lg-5">
              <div className="content-box-222">
                ...
                <p>Get in-depth knowledge about <Link href="/dynamics-365-business-central-features/">Dynamics 365 Business Central Features</Link>.</p>
                <p>
            ...
            <div className="col-lg-12">
              <header className="section-header">
                ...
                <p>
                  ...
                  built-in 'enterprise functionality', <Link href="/products/dynamics-365-business-central/advantages-capabilities/">Dynamics 365 Business Central offers a wide range of capabilities</Link> .
                  <br />
