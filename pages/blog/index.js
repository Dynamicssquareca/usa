...
export async function getServerSideProps() {
  try {
    ...
    const businesscentral = business.ok ? await business.json() : [];

    const categoryblog = await fetch(`${process.env.BACKEND_URL}/api/blog/category`);
    const categoryblogs = categoryblog.ok ? await categoryblog.json() : [];

    const blograndom = await fetch(`${process.env.BACKEND_URL}/api/random/allblog`);
    const blograndomblogs = blograndom.ok ? await blograndom.json() : [];

    const trandingblog = await fetch(`${process.env.BACKEND_URL}/api/blog/most/trending`);
    const blogtranding = trandingblog.ok ? await trandingblog.json() : [];
  ...
  return (
    <div>
      <Head>
        ...
        <link rel="canonical" href="https://www.dynamicssquare.com/blog/" />
        ...
        <meta property="og:url" content="https://www.dynamicssquare.com/blog/" />
                ...
                <div className="row g-5">
                  ...
                  <div className="col-lg-6">
                    <div className="blogs-side">
                      ...
                      {businesscentral.length > 0 && businesscentral.map((businessitem, i) => (
                        <div className="blogs-info-list blogs-info-list-side" key={i}>
                          <h3>
                          ...
                          <span className="time">
                            <a>
                              <i className="bi bi-clock"></i> {businessitem.read_time}
                            </a>
                          </span>
                          <span className="cate">
              ...
              <div className="container">
                <div className="row">
                  <div className="col-lg-6 align-self-center">
                    {blogtranding.length > 0 && blogtranding.map((trandig, i) => (
                      <div className="blogs-lates" key={i}>
                        <div className="blog-sian">
                        ...
                        <div className="blogs-info-list">
                          ...
                          <span className="cate">
                            <a href={`/blog/category/${trandig.category_slug}`}>
                ...
                <div className="row">
                  <div className="col-lg-3">
                    <div className="blogs-ex-side-cate">
                      ...
                      <ul>
                        {categoryblogs.length > 0 && categoryblogs.map((cateitem, i) => (
                          <li key={i}>
                  ...
                  <div className="col-lg-9">
                    {paginatedPosts.length > 0 && paginatedPosts.map((randomitem, i) => (
