                ...
                <div className="accordion" id="accnew">
                  <div className="accordion-item">
                    ...
                    >
                      ...
                      Boost your financial visibility with real-time efficiency, optimize stock levels & automatically create purchase orders, analyze & predict data, forecast & plan demand, and improve your entire financial performance with <Link href="/products/dynamics-365-business-central/"><a>Dynamics 365 Business Central</a></Link>{" "} Implementation.
                      </div>
                    </div>
                  </div>
                  <hr />
                  ...
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body">
                      Drive smoother <Link href="products/dynamics-365-customer-engagement/">
                      <a>customer engagement</a></Link> by enabling seamless collaboration between your sales team to service team. With streamline data intelligence, enable automatic item shipment, prompt response to customer queries, track & manage orders & returns, and more by implementing Dynamics 365 Business Central.
                      </div>
                    </div>
                  </div>
                  <hr />
                ...
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">
                     ...
                     <Link href="/"><a>Dynamics 365 implementation partner in USA</a></Link>, America. We can help to implement a highly customized
